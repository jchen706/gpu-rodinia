...
sw.epilog:                                        ; preds = %sw.bb59, %sw.bb52, %for.end, %if.then27
  br label %if.end60
...
kcall.configok:                                   ; preds = %for.body59
  ...
  call void @_Z4Fan1PfS_ii_host(float* %89, float* %90, i32 %91, i32 %92)
  br label %kcall.end
...
kcall.configok68:                                 ; preds = %kcall.end
  ...
  call void @_Z4Fan2PfS_S_iii_host(float* %109, float* %110, float* %111, i32 %112, i32 %sub69, i32 %115)
...
; Function Attrs: noinline optnone uwtable
define dso_local void @_Z4Fan1PfS_ii_host(float* %m_cuda, float* %a_cuda, i32 %Size, i32 %t) #0 {
entry:
...
; Function Attrs: noinline optnone uwtable
define dso_local void @_Z4Fan2PfS_S_iii_host(float* %m_cuda, float* %a_cuda, float* %b_cuda, i32 %Size, i32 %j1, i32 %t) #0 {
entry:
  %m_cuda.addr = alloca float*, align 8
  %a_cuda.addr = alloca float*, align 8
