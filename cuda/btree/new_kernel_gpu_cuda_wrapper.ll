; ModuleID = 'new_kernel_gpu_cuda_wrapper.bc'
...
entry:
  ...
  %33 = bitcast void (i8*)* @_Z5findKlP5knodelP6recordPlS3_PiS2__wrapper to i8*
  %call39 = call i32 @cudaLaunchKernel(i8* %33, i64 %grid.sroa.0.sroa.0.0.insert.insert, i32 1, i64 %block.sroa.0.sroa.0.0.insert.insert, i32 1, i8** nonnull %arrayinit.begin, i64 0, %struct.CUstream_st* null)
  ...
  %34 = load i8*, i8** %11, align 8, !tbaa !7
  %call44 = call i32 @cudaMemcpy(i8* %23, i8* %34, i64 %mul11, i32 2)
  call void @_Z14checkCUDAErrorPKc(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.12, i64 0, i64 0))
  %call45 = call i64 @_Z8get_timev()
  %35 = load i8*, i8** %1, align 8, !tbaa !7
  %call46 = call i32 @cudaFree(i8* %35)
  %36 = load i8*, i8** %3, align 8, !tbaa !7
  %call47 = call i32 @cudaFree(i8* %36)
  %37 = load i8*, i8** %5, align 8, !tbaa !7
  %call48 = call i32 @cudaFree(i8* %37)
  %38 = load i8*, i8** %7, align 8, !tbaa !7
  %call49 = call i32 @cudaFree(i8* %38)
  %39 = load i8*, i8** %9, align 8, !tbaa !7
  %call50 = call i32 @cudaFree(i8* %39)
  %40 = load i8*, i8** %11, align 8, !tbaa !7
  %call51 = call i32 @cudaFree(i8* %40)
...
declare dso_local void @_Z5findKlP5knodelP6recordPlS3_PiS2__wrapper(i8*)
