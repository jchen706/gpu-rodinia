; ModuleID = 'kernel_gpu_cuda_wrapper_2.bc'
...
entry:
  ...
  %call64 = call i32 @cudaLaunchKernel(i8* bitcast (void (i64, %struct.knode*, i64, i64*, i64*, i64*, i64*, i32*, i32*, i32*, i32*)* @_Z10findRangeKlP5knodelPlS1_S1_S1_PiS2_S2_S2_ to i8*), i64 4294967552, i32 1, i64 4294967297, i32 1, i8** nonnull %arrayinit.begin, i64 0, %struct.CUstream_st* null)
  ...
  %48 = load i8*, i8** %15, align 8, !tbaa !7
  %call69 = call i32 @cudaMemcpy(i8* %33, i8* %48, i64 %mul16, i32 2)
  call void @_Z14checkCUDAErrorPKc(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.17, i64 0, i64 0))
  %49 = load i8*, i8** %17, align 8, !tbaa !7
  %call72 = call i32 @cudaMemcpy(i8* %35, i8* %49, i64 %mul16, i32 2)
  call void @_Z14checkCUDAErrorPKc(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.18, i64 0, i64 0))
  %call73 = call i64 @_Z8get_timev()
  %50 = load i8*, i8** %1, align 8, !tbaa !7
  %call74 = call i32 @cudaFree(i8* %50)
  %51 = load i8*, i8** %3, align 8, !tbaa !7
  %call75 = call i32 @cudaFree(i8* %51)
  %52 = load i8*, i8** %5, align 8, !tbaa !7
  %call76 = call i32 @cudaFree(i8* %52)
  %53 = load i8*, i8** %7, align 8, !tbaa !7
  %call77 = call i32 @cudaFree(i8* %53)
  %54 = load i8*, i8** %9, align 8, !tbaa !7
  %call78 = call i32 @cudaFree(i8* %54)
  %55 = load i8*, i8** %11, align 8, !tbaa !7
  %call79 = call i32 @cudaFree(i8* %55)
  %56 = load i8*, i8** %13, align 8, !tbaa !7
  %call80 = call i32 @cudaFree(i8* %56)
  %57 = load i8*, i8** %15, align 8, !tbaa !7
  %call81 = call i32 @cudaFree(i8* %57)
  %58 = load i8*, i8** %17, align 8, !tbaa !7
  %call82 = call i32 @cudaFree(i8* %58)
