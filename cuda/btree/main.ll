...
for.body:                                         ; preds = %for.body.lr.ph, %_Z16list_item_deleteP9list_itemPFvPvE.exit
...
_Z16list_item_deleteP9list_itemPFvPvE.exit:       ; preds = %for.body, %if.then.i
...
if.end22:                                         ; preds = %if.then6, %if.else, %if.else17
  %length = getelementptr inbounds %struct.list_t, %struct.list_t* %l, i64 0, i32 2
...
for.inc:                                          ; preds = %land.rhs.lr.ph, %for.inc.land.rhs_crit_edge
...
if.end27:                                         ; preds = %if.then10, %if.else, %if.else22
  %length = getelementptr inbounds %struct.list_t, %struct.list_t* %l, i64 0, i32 2
...
if.end23:                                         ; preds = %if.then9, %if.else15, %if.then4, %if.else
  %length = getelementptr inbounds %struct.list_t, %struct.list_t* %l, i64 0, i32 2
  %11 = load i32, i32* %length, align 8, !tbaa !15
  %dec = add i32 %11, -1
...
_Z16list_item_deleteP9list_itemPFvPvE.exit:       ; preds = %if.end23, %if.then.i
...
_Z16list_remove_itemP6list_tP9list_item.exit:     ; preds = %if.then.i, %if.then.i.i
...
if.end23.i:                                       ; preds = %if.then.i, %if.then9.i
...
_Z16list_remove_itemP6list_tP9list_item.exit:     ; preds = %if.end23.i, %if.then.i.i
...
cond.end:                                         ; preds = %for.cond, %entry, %cond.true
...
for.body52:                                       ; preds = %for.body52.lr.ph, %_Z7enqueueP4node.exit279
...
while.cond.i275:                                  ; preds = %for.body52, %while.cond.i275
...
_Z7enqueueP4node.exit279:                         ; preds = %for.body52, %while.end.i278
...
while.cond.i286:                                  ; preds = %for.end70, %while.cond.i286
...
for.body123:                                      ; preds = %if.then111, %for.body123
...
for.body135:                                      ; preds = %for.end130, %for.body135
...
if.end28.i:                                       ; preds = %if.then22.i, %if.end28.loopexit.split.loop.exit112.i, %while.body.i
...
if.end:                                           ; preds = %while.cond.preheader.i, %_Z9find_leafP4nodeib.exit
...
for.body:                                         ; preds = %for.body.lr.ph, %if.then13
...
cleanup:                                          ; preds = %for.end, %for.cond.preheader, %for.body, %entry, %_Z9find_leafP4nodeib.exit
...
while.body.us:                                    ; preds = %while.body.lr.ph, %if.then26.us
...
if.then26.us:                                     ; preds = %if.then22.us, %if.then26.us.loopexit.split.loop.exit, %for.end.us
...
while.body17:                                     ; preds = %while.body17.lr.ph, %if.then22
...
if.end28:                                         ; preds = %if.then22, %if.end28.loopexit.split.loop.exit112, %while.body
...
for.body39:                                       ; preds = %if.then33, %for.body39
...
cleanup:                                          ; preds = %while.end31, %for.end46, %if.then, %if.then1
...
while.cond1.outer:                                ; preds = %while.cond1.preheader, %if.then15
...
for.body:                                         ; preds = %while.cond1, %for.inc
...
while.body:                                       ; preds = %_Z7enqueueP4node.exit, %if.end54
...
while.body.i.while.body.i_crit_edge:              ; preds = %while.body.i.preheader, %while.body.i.while.body.i_crit_edge
...
if.end12:                                         ; preds = %_Z12path_to_rootP4nodeS0_.exit, %while.body, %if.then9, %land.lhs.true
...
if.end22:                                         ; preds = %for.body, %if.then18
...
while.cond.i93:                                   ; preds = %for.body31, %while.cond.i93
...
_Z7enqueueP4node.exit97:                          ; preds = %for.body31, %while.end.i96
...
while.cond.i93.epil:                              ; preds = %for.body31.epil, %while.cond.i93.epil
...
while.cond.i93.1:                                 ; preds = %_Z7enqueueP4node.exit97, %while.cond.i93.1
...
cleanup:                                          ; preds = %for.end, %entry, %if.else
...
for.end:                                          ; preds = %for.body.prol.loopexit, %for.body, %entry, %while.end
...
for.cond60.preheader.loopexit:                    ; preds = %for.cond60.preheader.loopexit.unr-lcssa, %for.body44.epil
...
for.end101:                                       ; preds = %for.body95.prol.loopexit, %for.body95, %for.end78
...
for.body106.prol:                                 ; preds = %for.body106.preheader, %for.body106.prol
...
for.body106:                                      ; preds = %for.body106.prol.loopexit, %for.body106
...
for.end112:                                       ; preds = %for.body106.prol.loopexit, %for.body106, %for.end101
...
_Z14get_left_indexP4nodeS0_.exit:                 ; preds = %while.body.i, %if.end, %while.end.loopexit.split.loop.exit.i
...
_Z16insert_into_nodeP4nodeS0_iiS0_.exit:          ; preds = %for.body.i.prol.loopexit, %for.body.i, %entry.for.end_crit_edge.i
...
for.end:                                          ; preds = %for.body.prol.loopexit, %for.body, %entry.for.end_crit_edge
...
for.cond26.preheader:                             ; preds = %for.cond26.preheader.unr-lcssa, %for.body.epil
...
for.end41:                                        ; preds = %for.body29.epil, %for.end41.loopexit.unr-lcssa, %if.end11, %for.cond26.preheader
...
for.body105.epil:                                 ; preds = %for.end112.loopexit.unr-lcssa, %for.body105.epil
...
for.end112:                                       ; preds = %for.end112.loopexit.unr-lcssa, %for.body105.epil, %for.end95
...
for.cond.preheader.i:                             ; preds = %while.cond.preheader.i, %_Z9find_leafP4nodeib.exit
...
if.end:                                           ; preds = %for.inc.i, %entry, %for.end.i, %_Z9find_leafP4nodeib.exit, %_Z4findP4nodeib.exit
...
while.body.i45:                                   ; preds = %while.cond.preheader.i39, %if.end28.i64
...
if.end28.i64:                                     ; preds = %if.then22.i56, %if.end28.loopexit.split.loop.exit112.i57, %while.body.i45
...
for.body.i81.prol.loopexit:                       ; preds = %for.body.lr.ph.i77, %for.body.i81.prol
...
for.body.i81:                                     ; preds = %for.body.i81.prol.loopexit, %for.body.i81
...
_Z16insert_into_leafP4nodeiP6record.exit:         ; preds = %while.body.i75, %for.body.i81.prol.loopexit, %for.body.i81, %if.then8, %while.end.i
...
cleanup:                                          ; preds = %_Z4findP4nodeib.exit, %if.end10, %_Z16insert_into_leafP4nodeiP6record.exit, %if.then3
...
for.body22.for.body22_crit_edge.prol:             ; preds = %for.body22.for.body22_crit_edge.preheader, %for.body22.for.body22_crit_edge.prol
...
for.body22.for.body22_crit_edge:                  ; preds = %for.body22.for.body22_crit_edge.prol.loopexit, %for.body22.for.body22_crit_edge
...
for.end32:                                        ; preds = %for.body22.for.body22_crit_edge.prol.loopexit, %for.body22.for.body22_crit_edge, %for.body22.preheader, %for.cond20.preheader
  %dec = add i32 %.lcssa, -1
...
for.body51.prol:                                  ; preds = %for.body51.lr.ph, %for.body51.prol
...
if.end:                                           ; preds = %for.body40, %for.body51.prol.loopexit, %for.body51, %for.cond37.preheader, %for.cond49.preheader
  ret %struct.node* %n
}
...
if.end8:                                          ; preds = %if.then1, %if.then7
...
for.end:                                          ; preds = %if.end8, %for.end.loopexit
...
for.body43.for.body43_crit_edge:                  ; preds = %for.body43.preheader, %for.body43.for.body43_crit_edge
...
if.end68:                                         ; preds = %for.end, %for.end59
...
for.body73.epil:                                  ; preds = %if.end110.loopexit.unr-lcssa, %for.body73.epil
...
if.end110:                                        ; preds = %if.end110.loopexit.unr-lcssa, %for.body73.epil, %if.end68
...
if.then112:                                       ; preds = %if.end110.thread, %if.end110
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.body122
...
if.end138:                                        ; preds = %for.cond118, %if.then129, %if.then112
...
cleanup:                                          ; preds = %if.end2.i, %if.then, %cond.end, %if.else, %if.then35
...
for.body122.for.body122_crit_edge:                ; preds = %for.body122.lr.ph, %for.body122.for.body122_crit_edge
...
for.end138:                                       ; preds = %for.body122.lr.ph, %for.body122.for.end138.loopexit_crit_edge, %if.end118
...
if.end150:                                        ; preds = %for.end138, %if.then141, %if.then22, %if.else
...
while.cond.preheader.i20:                         ; preds = %for.inc.i, %if.else.i, %for.end.i, %_Z9find_leafP4nodeib.exit
...
while.body.i26:                                   ; preds = %while.cond.preheader.i20, %if.end28.i45
...
if.end28.i45:                                     ; preds = %if.then22.i37, %if.end28.loopexit.split.loop.exit112.i38, %while.body.i26
...
if.end:                                           ; preds = %entry, %if.then, %_Z9find_leafP4nodeib.exit49
...
if.end:                                           ; preds = %for.body, %for.body4, %for.cond.preheader, %for.cond1.preheader
...
entry:
  ...
  %cmp755 = icmp sgt i32 %argc, 1
  br i1 %cmp755, label %for.body, label %if.then32

for.body:                                         ; preds = %entry, %for.inc
  %cur_arg.0758 = phi i32 [ %inc, %for.inc ], [ 1, %entry ]
  %input_file.0757 = phi i8* [ %input_file.1, %for.inc ], [ null, %entry ]
  %command_file.0756 = phi i8* [ %command_file.1, %for.inc ], [ null, %entry ]
  %idxprom = sext i32 %cur_arg.0758 to i64
...
if.then6:                                         ; preds = %for.body
  %add = add nsw i32 %cur_arg.0758, 1
...
if.then20:                                        ; preds = %if.else12
  %add18 = add nsw i32 %cur_arg.0758, 1
...
for.inc:                                          ; preds = %if.then6, %if.then20, %if.else12
  %command_file.1 = phi i8* [ %command_file.0756, %if.then6 ], [ %2, %if.then20 ], [ %command_file.0756, %if.else12 ]
  %input_file.1 = phi i8* [ %1, %if.then6 ], [ %input_file.0757, %if.then20 ], [ %input_file.0757, %if.else12 ]
  %cur_arg.1 = phi i32 [ %add, %if.then6 ], [ %add18, %if.then20 ], [ %cur_arg.0758, %if.else12 ]
...
if.then32:                                        ; preds = %entry, %for.end
  %cmp30792 = phi i1 [ %cmp30, %for.end ], [ true, %entry ]
  %input_file.0.lcssa790 = phi i8* [ %input_file.1, %for.end ], [ null, %entry ]
  %command_file.0.lcssa788 = phi i8* [ %command_file.1, %for.end ], [ null, %entry ]
  %puts708 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([53 x i8], [53 x i8]* @str.127, i64 0, i64 0))
  br label %if.end34

if.end34:                                         ; preds = %for.end, %if.then32
  %cmp30791 = phi i1 [ %cmp30, %for.end ], [ %cmp30792, %if.then32 ]
  %input_file.0.lcssa789 = phi i8* [ %input_file.1, %for.end ], [ %input_file.0.lcssa790, %if.then32 ]
  %command_file.0.lcssa787 = phi i8* [ %command_file.1, %for.end ], [ %command_file.0.lcssa788, %if.then32 ]
  %call35 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([17 x i8], [17 x i8]* @.str.63, i64 0, i64 0), i8* %input_file.0.lcssa789)
  %call36 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([19 x i8], [19 x i8]* @.str.64, i64 0, i64 0), i8* %command_file.0.lcssa787)
  %call37 = tail call %struct._IO_FILE* @fopen(i8* %command_file.0.lcssa787, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.65, i64 0, i64 0))
...
if.then62:                                        ; preds = %if.end56
  %puts707 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([26 x i8], [26 x i8]* @str.126, i64 0, i64 0))
  br label %if.end64
...
if.end64:                                         ; preds = %if.then62, %if.end56
  ...
  br i1 %cmp30791, label %if.else80, label %if.then68

if.then68:                                        ; preds = %if.end64
  %call69 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([31 x i8], [31 x i8]* @.str.74, i64 0, i64 0), i8* nonnull %input_file.0.lcssa789)
  %call70 = tail call %struct._IO_FILE* @fopen(i8* nonnull %input_file.0.lcssa789, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.75, i64 0, i64 0))
...
if.end73:                                         ; preds = %if.then68
  ...
  %call75751 = call i32 @feof(%struct._IO_FILE* nonnull %call70) #15
  %tobool76752 = icmp eq i32 %call75751, 0
  br i1 %tobool76752, label %while.body, label %while.end

while.body:                                       ; preds = %if.end73, %while.body
  %root.0753 = phi %struct.node* [ %call78, %while.body ], [ null, %if.end73 ]
  ...
  %call78 = call %struct.node* @_Z6insertP4nodeii(%struct.node* %root.0753, i32 %12, i32 %12)
...
while.end:                                        ; preds = %while.body, %if.end73
  ...
  %puts702 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([49 x i8], [49 x i8]* @str.123, i64 0, i64 0))
...
_Z6heightP4node.exit:                             ; preds = %_Z6heightP4node.exit.loopexit, %while.end
  ...
  %puts703 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([20 x i8], [20 x i8]* @str.124, i64 0, i64 0))
  %call88 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([3 x i8], [3 x i8]* @.str.81, i64 0, i64 0))
  %call90746 = call i32 (i8*, i8*, ...) @sscanf(i8* nonnull %call44, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.82, i64 0, i64 0), i8* nonnull %instruction) #15
  %cmp91747 = icmp eq i32 %call90746, -1
  br i1 %cmp91747, label %while.end474, label %while.body92.lr.ph
...
if.else80:                                        ; preds = %if.end64
  %puts701 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([30 x i8], [30 x i8]* @str.122, i64 0, i64 0))
  br label %cleanup489

while.body92:                                     ; preds = %while.body92.lr.ph, %sw.epilog
  %root.1749 = phi %struct.node* [ %root.0.lcssa, %while.body92.lr.ph ], [ %root.2, %sw.epilog ]
  %commandPointer.0748 = phi i8* [ %call44, %while.body92.lr.ph ], [ %commandPointer.4, %sw.epilog ]
  %incdec.ptr = getelementptr inbounds i8, i8* %commandPointer.0748, i64 1
...
while.end99:                                      ; preds = %while.cond95
  ...
  %call100 = call %struct.node* @_Z6insertP4nodeii(%struct.node* %root.1749, i32 %27, i32 %27)
...
while.cond104:                                    ; preds = %while.cond104, %sw.bb102
  ...
  %call.i711 = call i32 @_IO_getc(%struct._IO_FILE* %28)
  %cmp106 = icmp eq i32 %call.i711, 10
...
while.end108:                                     ; preds = %while.cond104
  ...
  %call.i712 = call %struct.node* @_Z9find_leafP4nodeib(%struct.node* %root.1749, i32 %29, i1 zeroext %cmp110) #15
  %cmp.i = icmp eq %struct.node* %call.i712, null
  br i1 %cmp.i, label %if.then113, label %for.cond.preheader.i

for.cond.preheader.i:                             ; preds = %while.end108
  %num_keys.i = getelementptr inbounds %struct.node, %struct.node* %call.i712, i64 0, i32 4
  %31 = load i32, i32* %num_keys.i, align 4, !tbaa !29
  %cmp122.i = icmp sgt i32 %31, 0
  br i1 %cmp122.i, label %for.body.lr.ph.i, label %for.end.i

for.body.lr.ph.i:                                 ; preds = %for.cond.preheader.i
  %keys.i = getelementptr inbounds %struct.node, %struct.node* %call.i712, i64 0, i32 1
...
_Z4findP4nodeib.exit:                             ; preds = %for.end.i
  %pointers.i = getelementptr inbounds %struct.node, %struct.node* %call.i712, i64 0, i32 0
  %36 = load i8**, i8*** %pointers.i, align 8, !tbaa !32
  %idxprom8.i = zext i32 %i.0.lcssa.i to i64
...
if.then113:                                       ; preds = %for.inc.i, %for.end.i, %while.end108, %_Z4findP4nodeib.exit
...
while.cond120:                                    ; preds = %while.cond120, %sw.bb118
  ...
  %call.i714 = call i32 @_IO_getc(%struct._IO_FILE* %41)
  %cmp122 = icmp eq i32 %call.i714, 10
  br i1 %cmp122, label %while.end124, label %while.cond120

while.end124:                                     ; preds = %while.cond120
  %42 = load i32, i32* %input, align 4, !tbaa !20
  %call125 = call %struct.node* @_Z9deleteValP4nodei(%struct.node* %root.1749, i32 %42)
  call void @_Z10print_treeP4node(%struct.node* %call125)
  br label %sw.epilog

while.cond127:                                    ; preds = %while.body92, %while.cond127
  %43 = load %struct._IO_FILE*, %struct._IO_FILE** @stdin, align 8, !tbaa !14
  %call.i715 = call i32 @_IO_getc(%struct._IO_FILE* %43)
  %cmp129 = icmp eq i32 %call.i715, 10
  br i1 %cmp129, label %while.end131, label %while.cond127

while.end131:                                     ; preds = %while.cond127
  call void @_Z18destroy_tree_nodesP4node(%struct.node* %root.1749) #15
  %puts.i = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([12 x i8], [12 x i8]* @str.119, i64 0, i64 0)) #15
  br label %sw.epilog

while.cond134:                                    ; preds = %while.body92, %while.cond134
  %44 = load %struct._IO_FILE*, %struct._IO_FILE** @stdin, align 8, !tbaa !14
  %call.i716 = call i32 @_IO_getc(%struct._IO_FILE* %44)
  %cmp136 = icmp eq i32 %call.i716, 10
  br i1 %cmp136, label %while.end138, label %while.cond134

while.end138:                                     ; preds = %while.cond134
  call void @_Z12print_leavesP4node(%struct.node* %root.1749)
  br label %sw.epilog

while.cond140:                                    ; preds = %while.body92, %while.cond140
  %45 = load %struct._IO_FILE*, %struct._IO_FILE** @stdin, align 8, !tbaa !14
  %call.i717 = call i32 @_IO_getc(%struct._IO_FILE* %45)
  %cmp142 = icmp eq i32 %call.i717, 10
  br i1 %cmp142, label %while.end144, label %while.cond140

while.end144:                                     ; preds = %while.cond140
  call void @_Z10print_treeP4node(%struct.node* %root.1749)
  br label %sw.epilog

while.cond146:                                    ; preds = %while.body92, %while.cond146
  %46 = load %struct._IO_FILE*, %struct._IO_FILE** @stdin, align 8, !tbaa !14
  %call.i718 = call i32 @_IO_getc(%struct._IO_FILE* %46)
  %cmp148 = icmp eq i32 %call.i718, 10
...
while.cond154:                                    ; preds = %while.body92, %while.cond154
  %49 = load %struct._IO_FILE*, %struct._IO_FILE** @stdin, align 8, !tbaa !14
  %call.i719 = call i32 @_IO_getc(%struct._IO_FILE* %49)
  %cmp156 = icmp eq i32 %call.i719, 10
...
if.then171:                                       ; preds = %while.end168
  %puts706 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([92 x i8], [92 x i8]* @str.125, i64 0, i64 0))
...
if.end173:                                        ; preds = %while.end168
  ...
  %53 = load i32, i32* %count, align 4, !tbaa !20
  %cmp216739 = icmp sgt i32 %53, 0
  br i1 %cmp216739, label %for.body217, label %for.end228

for.body217:                                      ; preds = %if.end173, %for.body217
  %i.0740 = phi i32 [ %inc227, %for.body217 ], [ 0, %if.end173 ]
  %call218 = call i32 @rand() #15
  %inc227 = add nuw nsw i32 %i.0740, 1
  %54 = load i32, i32* %count, align 4, !tbaa !20
  %cmp216 = icmp slt i32 %inc227, %54
  br i1 %cmp216, label %for.body217, label %for.end228

for.end228:                                       ; preds = %for.body217, %if.end173
  %.lcssa722 = phi i32 [ %53, %if.end173 ], [ %54, %for.body217 ]
  %conv230 = sext i32 %.lcssa722 to i64
  %mul231 = shl nsw i64 %conv230, 2
  %call232 = call noalias i8* @malloc(i64 %mul231) #15
  %tobool233 = icmp eq i8* %call232, null
  br i1 %tobool233, label %if.then234, label %if.end236

if.then234:                                       ; preds = %for.end228
  %55 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !14
  %call235 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %55, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 2195) #16
  call void @exit(i32 -1) #17
  unreachable

if.end236:                                        ; preds = %for.end228
  %56 = bitcast i8* %call232 to %struct.record*
  %cmp239742 = icmp sgt i32 %.lcssa722, 0
  br i1 %cmp239742, label %for.body240.preheader, label %for.end246

for.body240.preheader:                            ; preds = %if.end236
  %wide.trip.count779 = zext i32 %.lcssa722 to i64
  %57 = shl nuw nsw i64 %wide.trip.count779, 2
  call void @llvm.memset.p0i8.i64(i8* nonnull align 4 %call232, i8 -1, i64 %57, i1 false)
  br label %for.end246
...
if.end251:                                        ; preds = %if.then249, %for.end246
  %58 = load i32, i32* %count, align 4, !tbaa !20
  %call252 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %call247, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.86, i64 0, i64 0), i32 %58)
  %59 = load i32, i32* %count, align 4, !tbaa !20
  %cmp254744 = icmp sgt i32 %59, 0
  br i1 %cmp254744, label %for.body255, label %for.end262

for.body255:                                      ; preds = %if.end251, %for.body255
  %indvars.iv780 = phi i64 [ %indvars.iv.next781, %for.body255 ], [ 0, %if.end251 ]
  %value258 = getelementptr inbounds %struct.record, %struct.record* %56, i64 %indvars.iv780, i32 0
  %60 = load i32, i32* %value258, align 4, !tbaa !33
  %61 = trunc i64 %indvars.iv780 to i32
  %call259 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %call247, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.92, i64 0, i64 0), i32 %61, i32 %60)
  %indvars.iv.next781 = add nuw nsw i64 %indvars.iv780, 1
  %62 = load i32, i32* %count, align 4, !tbaa !20
  %63 = sext i32 %62 to i64
  %cmp254 = icmp slt i64 %indvars.iv.next781, %63
  br i1 %cmp254, label %for.body255, label %for.end262

for.end262:                                       ; preds = %for.body255, %if.end251
  %64 = call i64 @fwrite_unlocked(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.93, i64 0, i64 0), i64 2, i64 1, %struct._IO_FILE* %call247)
...
sw.bb265:                                         ; preds = %while.body92
  ...
  %65 = load i32, i32* %start, align 4, !tbaa !20
  %66 = load i32, i32* %end, align 4, !tbaa !20
  %cmp268 = icmp sgt i32 %65, %66
  br i1 %cmp268, label %if.then269, label %if.end270

if.then269:                                       ; preds = %sw.bb265
  store i32 %65, i32* %input, align 4, !tbaa !20
  store i32 %66, i32* %start, align 4, !tbaa !20
  store i32 %65, i32* %end, align 4, !tbaa !20
  br label %if.end270

if.end270:                                        ; preds = %if.then269, %sw.bb265
  %67 = phi i32 [ %65, %if.then269 ], [ %66, %sw.bb265 ]
  %68 = phi i32 [ %66, %if.then269 ], [ %65, %sw.bb265 ]
  %call271 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([21 x i8], [21 x i8]* @.str.94, i64 0, i64 0), i32 %68, i32 %67)
  %69 = load i32, i32* %start, align 4, !tbaa !20
  %70 = load i32, i32* %end, align 4, !tbaa !20
  %call272 = call %struct.list_t* @_Z9findRangeP4nodeii(%struct.node* %root.1749, i32 %69, i32 %70)
  %length.i = getelementptr inbounds %struct.list_t, %struct.list_t* %call272, i64 0, i32 2
  %71 = load i32, i32* %length.i, align 8, !tbaa !15
  %call274 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([18 x i8], [18 x i8]* @.str.95, i64 0, i64 0), i32 %71)
  %72 = bitcast %struct.list_t* %call272 to i8*
  call void @free(i8* %72) #15
...
while.cond278:                                    ; preds = %while.body285, %sw.bb275
  ...
  %73 = load i8, i8* %commandPointer.2, align 1, !tbaa !47
  switch i8 %73, label %while.body285 [
...
while.cond289:                                    ; preds = %while.body296, %while.end287
  ...
  %74 = load i8, i8* %commandPointer.3, align 1, !tbaa !47
  switch i8 %74, label %while.body296 [
...
while.end298:                                     ; preds = %while.cond289, %while.cond289
  %75 = load i32, i32* %count276, align 4, !tbaa !20
  %76 = load i32, i32* %rSize, align 4, !tbaa !20
  %call299 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([39 x i8], [39 x i8]* @.str.96, i64 0, i64 0), i32 %75, i32 %76)
  %77 = load i32, i32* %rSize, align 4, !tbaa !20
  %conv300 = sext i32 %77 to i64
  %78 = load i64, i64* @size, align 8, !tbaa !18
  %cmp301 = icmp slt i64 %78, %conv300
  %cmp303 = icmp slt i32 %77, 0
  %or.cond497 = or i1 %cmp303, %cmp301
  br i1 %or.cond497, label %if.then304, label %if.end307

if.then304:                                       ; preds = %while.end298
  %conv305 = trunc i64 %78 to i32
...
if.end307:                                        ; preds = %while.end298
  %79 = load i64, i64* bitcast (i8** @mem to i64*), align 8, !tbaa !14
  %add309 = add nsw i64 %79, %sub
  %80 = inttoptr i64 %add309 to %struct.knode*
  ...
  %81 = load i32, i32* %count276, align 4, !tbaa !20
  %conv320 = sext i32 %81 to i64
...
if.then324:                                       ; preds = %if.end307
  %82 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !14
  %call325 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %82, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 2304) #16
  call void @exit(i32 -1) #17
  unreachable

if.end326:                                        ; preds = %if.end307
  %83 = bitcast i8* %call322 to i64*
...
if.then336:                                       ; preds = %if.end326
  ...
  %call337 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %84, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 2310) #16
  call void @exit(i32 -1) #17
  unreachable

if.end338:                                        ; preds = %if.end326
  %85 = bitcast i8* %call334 to i64*
...
if.then347:                                       ; preds = %if.end338
  %86 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !14
  %call348 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %86, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 2316) #16
  call void @exit(i32 -1) #17
  unreachable

if.end349:                                        ; preds = %if.end338
  %87 = bitcast i8* %call345 to i64*
...
if.then358:                                       ; preds = %if.end349
  %88 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !14
  %call359 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %88, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 2322) #16
  call void @exit(i32 -1) #17
  unreachable

if.end360:                                        ; preds = %if.end349
  %89 = bitcast i8* %call356 to i64*
...
if.then370:                                       ; preds = %if.end360
  %90 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !14
  %call371 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %90, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 2328) #16
  call void @exit(i32 -1) #17
  unreachable

if.end372:                                        ; preds = %if.end360
  %91 = bitcast i8* %call368 to i32*
...
if.then380:                                       ; preds = %if.end372
  %92 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !14
  %call381 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %92, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 2330) #16
  call void @exit(i32 -1) #17
  unreachable

if.end382:                                        ; preds = %if.end372
  %93 = bitcast i8* %call378 to i32*
  %cmp386733 = icmp sgt i32 %81, 0
  br i1 %cmp386733, label %for.body387, label %for.end424

for.body387:                                      ; preds = %if.end382, %for.inc422
  ...
  %94 = load i64, i64* @size, align 8, !tbaa !18
  %conv391 = sitofp i64 %94 to float
  %mul392 = fmul float %div390, %conv391
  %conv393 = fptosi float %mul392 to i32
  %arrayidx395 = getelementptr inbounds i32, i32* %91, i64 %indvars.iv
  store i32 %conv393, i32* %arrayidx395, align 4, !tbaa !20
  %95 = load i32, i32* %rSize, align 4, !tbaa !20
  %add398 = add nsw i32 %95, %conv393
  %arrayidx400 = getelementptr inbounds i32, i32* %93, i64 %indvars.iv
  store i32 %add398, i32* %arrayidx400, align 4, !tbaa !20
  %conv403 = sext i32 %add398 to i64
  %cmp404 = icmp sgt i64 %94, %conv403
  br i1 %cmp404, label %for.inc422, label %if.then405

if.then405:                                       ; preds = %for.body387
  %96 = trunc i64 %94 to i32
  %97 = add i32 %conv393, %96
  %conv414 = sub i32 %97, %add398
  store i32 %conv414, i32* %arrayidx395, align 4, !tbaa !20
  %conv418 = add i32 %96, -1
  store i32 %conv418, i32* %arrayidx400, align 4, !tbaa !20
  br label %for.inc422

for.inc422:                                       ; preds = %for.body387, %if.then405
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %98 = load i32, i32* %count276, align 4, !tbaa !20
  %99 = sext i32 %98 to i64
  %cmp386 = icmp slt i64 %indvars.iv.next, %99
  br i1 %cmp386, label %for.body387, label %for.end424.loopexit

for.end424.loopexit:                              ; preds = %for.inc422
  %100 = sext i32 %98 to i64
  %.pre = shl nsw i64 %100, 2
  br label %for.end424

for.end424:                                       ; preds = %for.end424.loopexit, %if.end382
  %mul427.pre-phi = phi i64 [ %.pre, %for.end424.loopexit ], [ %mul367, %if.end382 ]
  %.lcssa = phi i32 [ %98, %for.end424.loopexit ], [ %81, %if.end382 ]
...
if.then430:                                       ; preds = %for.end424
  ...
  %call431 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %101, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 2344) #16
  call void @exit(i32 -1) #17
  unreachable

if.end432:                                        ; preds = %for.end424
  %102 = bitcast i8* %call428 to i32*
...
if.then439:                                       ; preds = %if.end432
  %103 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !14
  %call440 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %103, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 2346) #16
  call void @exit(i32 -1) #17
  unreachable

if.end441:                                        ; preds = %if.end432
  %104 = bitcast i8* %call437 to i32*
  %cmp444735 = icmp sgt i32 %.lcssa, 0
  br i1 %cmp444735, label %for.body445.preheader, label %for.end452

for.body445.preheader:                            ; preds = %if.end441
  %wide.trip.count = zext i32 %.lcssa to i64
  %105 = shl nuw nsw i64 %wide.trip.count, 2
  call void @llvm.memset.p0i8.i64(i8* nonnull align 4 %call428, i8 0, i64 %105, i1 false)
  call void @llvm.memset.p0i8.i64(i8* nonnull align 4 %call437, i8 0, i64 %105, i1 false)
  br label %for.end452
...
for.end452:                                       ; preds = %for.body445.preheader, %if.end441
  ...
  %106 = load i32, i32* @order, align 4, !tbaa !20
  %107 = load i64, i64* @maxheight, align 8, !tbaa !18
  %108 = load i32, i32* %count276, align 4, !tbaa !20
  call void @_Z25kernel_gpu_cuda_wrapper_2P5knodelliliPlS1_S1_S1_PiS2_S2_S2_(%struct.knode* %80, i64 %div312, i64 %sub311, i32 %106, i64 %107, i32 %108, i64* nonnull %83, i64* nonnull %85, i64* nonnull %87, i64* nonnull %89, i32* nonnull %91, i32* nonnull %93, i32* nonnull %102, i32* nonnull %104)
...
if.end458:                                        ; preds = %if.then456, %for.end452
  %109 = load i32, i32* %count276, align 4, !tbaa !20
  %110 = load i32, i32* %rSize, align 4, !tbaa !20
  %call459 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %call454, i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.96, i64 0, i64 0), i32 %109, i32 %110)
  %111 = load i32, i32* %count276, align 4, !tbaa !20
  %cmp461737 = icmp sgt i32 %111, 0
  br i1 %cmp461737, label %for.body462, label %for.end470

for.body462:                                      ; preds = %if.end458, %for.body462
  %indvars.iv775 = phi i64 [ %indvars.iv.next776, %for.body462 ], [ 0, %if.end458 ]
  %arrayidx464 = getelementptr inbounds i32, i32* %102, i64 %indvars.iv775
  %112 = load i32, i32* %arrayidx464, align 4, !tbaa !20
  %arrayidx466 = getelementptr inbounds i32, i32* %104, i64 %indvars.iv775
  %113 = load i32, i32* %arrayidx466, align 4, !tbaa !20
  %114 = trunc i64 %indvars.iv775 to i32
  %call467 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %call454, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.99, i64 0, i64 0), i32 %114, i32 %112, i32 %113)
  %indvars.iv.next776 = add nuw nsw i64 %indvars.iv775, 1
  %115 = load i32, i32* %count276, align 4, !tbaa !20
  %116 = sext i32 %115 to i64
  %cmp461 = icmp slt i64 %indvars.iv.next776, %116
  br i1 %cmp461, label %for.body462, label %for.end470

for.end470:                                       ; preds = %for.body462, %if.end458
  %117 = call i64 @fwrite_unlocked(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.93, i64 0, i64 0), i64 2, i64 1, %struct._IO_FILE* %call454)
...
sw.epilog:                                        ; preds = %while.body92, %if.then113, %if.else115, %for.end470, %if.end270, %for.end262, %while.end150, %while.end144, %while.end138, %while.end131, %while.end124, %while.end99
  ...
  %root.2 = phi %struct.node* [ %root.1749, %while.body92 ], [ %root.1749, %for.end470 ], [ %root.1749, %if.end270 ], [ %root.1749, %for.end262 ], [ %root.1749, %while.end150 ], [ %root.1749, %while.end144 ], [ %root.1749, %while.end138 ], [ null, %while.end131 ], [ %call125, %while.end124 ], [ %root.1749, %if.then113 ], [ %root.1749, %if.else115 ], [ %call100, %while.end99 ]
...
while.end474:                                     ; preds = %sw.epilog, %_Z6heightP4node.exit
  ...
  %118 = load i8*, i8** @mem, align 8, !tbaa !14
  call void @free(i8* %118) #15
  br label %cleanup489

cleanup489:                                       ; preds = %while.cond154, %if.else80, %while.end474
